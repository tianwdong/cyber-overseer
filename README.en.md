...
**[Download the macOS preview DMG](https://github.com/tianwdong/cyber-overseer/releases/tag/v0.1.11)** · Apple Silicon · approximately 130 MiB. Not notarized. See [App and DMG packaging](docs/packaging.md) for installation and build details (Chinese).

### Windows app

**[Download the Windows x64 preview installer](https://github.com/tianwdong/cyber-overseer/releases/tag/v0.1.11)**. Run the `.exe` and choose an installation directory. Python and SQLite are bundled; no separate Node.js or Python installation is needed. The installer supports English and Chinese, with removal through Windows Settings.
...
Version 0.1.11 supports **automatic update downloads**. It checks about every six hours and matches installers to your OS and architecture. Check manually or disable automatic checks in Settings. New installers download automatically and are verified before you can open them. Install when convenient; downloads do not interrupt your tasks. [Update behavior and privacy](docs/app-updates.md)
