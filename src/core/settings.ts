...
export interface Settings {notifyOnAttention?:boolean;retryAfterFailure:boolean;maxAttempts:number;language:'codex'|Language}
...
export function parseSettings(value:unknown):Settings {
  ...
  return {...(s.notifyOnAttention===undefined?{}:{notifyOnAttention:s.notifyOnAttention}),retryAfterFailure:s.retryAfterFailure,maxAttempts:s.maxAttempts,language:s.language};
}
