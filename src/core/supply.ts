...
export type SupplyError = 'codex-missing'|'timeout'|'unavailable';
export interface SupplyState {accountError?:SupplyError;companion?:import('./companion-summary').CompanionSummary;watch?:import("./attention").WatchSummary;account:AccountSupply|null;task:TaskUsage|null;title:string|null}
